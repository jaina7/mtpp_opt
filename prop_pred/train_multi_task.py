...
if __name__ == '__main__':
    ...
    print('Get model')
    model = get_model(args.model_type, args.input_dim, args.depth, args.output_dim, args.p)
    ...
    print('Test model')
    test_loss = eval_model(model, test_loader, args.device)
    ...
    with open(args.log_file, 'a') as f:
        model_id = f'{args.model_type}_{args.input_dim}_{args.depth}_{args.output_dim}_{args.p}'
        train_loss = train_losses[-1]
        val_loss = val_losses[-1]
        f.write(f'{model_id}, {train_loss}, {val_loss}, {test_loss}\n')